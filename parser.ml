...
let rec _menhir_run10 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    ...
    match _tok with
    | Lbool _v ->
        _menhir_run8 _menhir_env (Obj.magic _menhir_stack) MenhirState10 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lint _v ->
...
and _menhir_run12 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState12 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run20 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
...
and _menhir_run22 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState22 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run24 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState24 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run26 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState26 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run28 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState28 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run14 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState14 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
and _menhir_run18 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.Syntax.expr) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    ...
    | Lint _v ->
        _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState18 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lopar ->
...
# 310 "parser.ml"
    ...
    | MenhirState10 ->
        ...
        | Lmul ->
            _menhir_run12 _menhir_env (Obj.magic _menhir_stack) _menhir_env._menhir_lexbuf.Lexing.lex_start_p
        | Ladd | Lcpar | Leq | Lgt | Lgte | Llt | Llte | Lneq | Lsc | Lsub ->
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 384 "parser.ml"
    ...
    | MenhirState16 ->
        ...
        | Lsub ->
            _menhir_run10 _menhir_env (Obj.magic _menhir_stack) _menhir_env._menhir_lexbuf.Lexing.lex_start_p
        | Lcpar | Leq | Lgt | Lgte | Llt | Llte | Lneq | Lsc ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _menhir_s, (a : (Ast.Syntax.expr))), _startpos__2_), _, (b : (Ast.Syntax.expr))) = _menhir_stack in
            let _v : (Ast.Syntax.expr) = 
# 73 "parser.mly"
                           (
  Call { func = "%neq" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 408 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 82 "parser.mly"
                           (
  Call { func = "%lte" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 464 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 76 "parser.mly"
                          (
  Call { func = "%lt" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 494 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 85 "parser.mly"
                           (
  Call { func = "%gte" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 524 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 79 "parser.mly"
                          (
  Call { func = "%gt" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 554 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 70 "parser.mly"
                          (
  Call { func = "%eq" ; args = [ a ; b ] ; pos = _startpos__2_ }
)
# 584 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    ...
    | MenhirState40 ->
        ...
        | Lsc ->
            ...
            | Lint_t ->
                _menhir_run33 _menhir_env (Obj.magic _menhir_stack) MenhirState42 _menhir_env._menhir_lexbuf.Lexing.lex_start_p
            | Lvar _v ->
                _menhir_run1 _menhir_env (Obj.magic _menhir_stack) MenhirState42 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
...
# 49 "parser.mly"
                 (
  Value { value = Int (-n) ; pos = _startpos }
)
# 745 "parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run6 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    match _tok with
    | Lbool _v ->
        _menhir_run8 _menhir_env (Obj.magic _menhir_stack) MenhirState6 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
    | Lint _v ->
...
# 52 "parser.mly"
            (
  Value { value = Bool b ; pos = _startpos }
)
# 820 "parser.ml"
     in
    _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_goto_block : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.Syntax.block) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState38 ->
        ...
        let ((_menhir_stack, _menhir_s, (t : (Ast.type_t)), _startpos_t_), (v : (
# 8 "parser.mly"
       (string)
# 834 "parser.ml"
...
# 25 "parser.mly"
                                       (
  Decl { name = v ; type_t = t ; pos = _startpos_t_ }
  :: b
)
# 842 "parser.ml"
         in
...
# 8 "parser.mly"
       (string)
# 852 "parser.ml"
        )), _startpos_v_), _startpos__3_), _, (e : (Ast.Syntax.expr))) = _menhir_stack in
        let _v : (Ast.Syntax.block) = 
# 33 "parser.mly"
                                                          (
  Decl { name = v ; type_t = t ; pos = _startpos_t_ }
...
# 8 "parser.mly"
       (string)
# 871 "parser.ml"
        )), _startpos_v_), _startpos__2_), _, (e : (Ast.Syntax.expr))) = _menhir_stack in
        let _v : (Ast.Syntax.block) = 
# 29 "parser.mly"
                                              (
...
and _menhir_goto_type_t : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.type_t) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos ->
    ...
    | Lvar _v ->
        ...
        | Lassign ->
            ...
            | Lint _v ->
                _menhir_run7 _menhir_env (Obj.magic _menhir_stack) MenhirState40 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
            | Lopar ->
            ...
            | Lvar _v ->
                _menhir_run3 _menhir_env (Obj.magic _menhir_stack) MenhirState40 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
        ...
        | Lsc ->
            ...
            | Lvar _v ->
                _menhir_run1 _menhir_env (Obj.magic _menhir_stack) MenhirState38 _v _menhir_env._menhir_lexbuf.Lexing.lex_start_p
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
...
# 1073 "parser.ml"
     in
    _menhir_goto_type_t _menhir_env _menhir_stack _menhir_s _v _startpos
